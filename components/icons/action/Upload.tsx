    ...
    >
      <g transform="translate(1.62, 1.63) scale(0.1188)">
        ...
        <g className="duotone-primary" fill="currentColor">
          <path d="M98.043,133.675l-20.992.013c-4.6.003-9.219-3.474-9.228-8.718l-.113-62.734-23.827-.115c-2.34-.011-5.46-1.644-6.364-3.283-1.031-1.869-1.046-6.191.467-7.865L81.65,2.661c3.387-3.748,8.461-3.393,11.663.157l43.175,47.865c1.412,1.566,1.696,5.421,1.069,7.167-.584,1.626-3.396,4.186-5.29,4.201l-25.359.205.116,61.713c.01,5.435-3.49,9.7-8.98,9.704Z"/>
        </g>
      </g>
    </svg>
  )
