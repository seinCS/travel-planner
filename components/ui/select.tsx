  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-2 rounded-xl px-4 py-2 text-sm whitespace-nowrap",
        ...
        "shadow-[0_1px_2px_oklch(0_0_0/3%)]",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "shadow-[0_4px_8px_oklch(0_0_0/4%),0_8px_16px_oklch(0_0_0/4%),0_16px_32px_oklch(0_0_0/4%)]",
          position === "popper" &&
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-gray-100/80 focus:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground",
